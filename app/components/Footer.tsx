    ...
    <footer className="text-white py-12" style={{ backgroundColor: '#4C1D95' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Sofi</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/signup" style={{ color: '#DDD6FE' }} className="hover:text-white">Get Started Free</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <p style={{ color: '#DDD6FE' }}>support@getsofi.com</p>
            <p className="mt-2" style={{ color: '#DDD6FE' }}>800 N King Street 304-1991, Wilmington, DE 19801</p>
            <p className="mt-2" style={{ color: '#DDD6FE' }}>(833) 729-1045</p>
          </div>
        </div>
        <div className="mt-8 pt-8 text-center" style={{ borderTop: '1px solid #7C3AED', color: '#DDD6FE' }}>
          <p>&copy; 2026 Sofi. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
