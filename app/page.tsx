    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FFFFFF' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-5xl font-extrabold sm:text-6xl md:text-7xl" style={{ color: '#1F2937' }}>
              Smarter Financial Guidance
              <span className="block" style={{ color: '#7C3AED' }}>Personalized for You</span>
            </h1>
            <p className="mt-6 max-w-2xl mx-auto text-xl" style={{ color: '#6B7280' }}>
              Get instant, unbiased answers to all your financial questions — no salespeople, no pressure, just honest guidance tailored to your needs.
            </p>
      ...
      <section className="py-20" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold" style={{ color: '#1F2937' }}>Why Choose Sofi</h2>
            <p className="mt-4 text-xl" style={{ color: '#6B7280' }}>Your personal guide to smarter financial decisions.</p>
          </div>
      ...
      <section className="py-20" style={{ backgroundColor: '#F5F3FF' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-10" style={{ color: '#6B7280' }}>Join thousands of people who trust Sofi.</p>
