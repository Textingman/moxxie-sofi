      ...
      <section className="py-12" style={{ backgroundColor: '#F5F7FA' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold mb-4" style={{ color: '#1F2937' }}>
            Get Your Free Financial Guidance — Today
          </h1>
          <p className="text-xl max-w-2xl mx-auto" style={{ color: '#6B7280' }}>
            Personalized, unbiased financial guidance — no sales calls, no pressure, just honest answers.
          </p>
        </div>
      </section>
          ...
          {submitStatus === 'success' ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start gap-3 pt-2">
                <input type="checkbox" id="termsAgreement" required className="mt-1 w-4 h-4 rounded" style={{ accentColor: '#7C3AED' }} />
                <label htmlFor="termsAgreement" className="text-sm" style={{ color: '#6B7280' }}>
                  I have read and agree to the{' '}
                  <a href="/privacy" style={{ color: '#7C3AED' }} className="underline">Privacy Policy</a>
                  {' '}and{' '}
                  <a href="/terms" style={{ color: '#7C3AED' }} className="underline">Terms of Service</a>. *
                </label>
              </div>
              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="accountNotifications" className="text-sm" style={{ color: '#6B7280' }}>
                    By checking this box, I agree to receive Transactional Account Notification SMS messages from Sofi at the phone number provided. I understand I may opt out at any time by replying STOP. Reply HELP for help. Message and data rates may apply. Message frequency varies. Opting in is optional and not required to submit this form. Consent is not required as a condition of purchasing any products or services.
                  </label>
                </div>
                <div className="flex items-start gap-3">
