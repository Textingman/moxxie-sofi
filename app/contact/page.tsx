            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:support@getsofi.com" className="text-base font-medium hover:underline" style={{ color: '#7C3AED' }}>support@getsofi.com</a>
                ...
                <div>
                  ...
                  <p style={{ color: '#6B7280' }}>Sofi<br />800 N King Street 304-1991<br />Wilmington, DE 19801</p>
                </div>
                <div>
